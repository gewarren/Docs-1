...
For more details about these options, see [Creating ASP.NET Web Projects in Visual Studio](../../../visual-studio/overview/2017/creating-web-projects-in-visual-studio.md#authentication-methods).
